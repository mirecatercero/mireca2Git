...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/imagenes/',
            'upload_url' => $this->get_full_url().'/imagenes/',
    ...
    protected function get_file_objects($iteration_method = 'get_file_object') {
        ...
        $fotos = "SELECT foto from rayosx where idpaciente = $idpaciente and idtipo = '$idtipo'";
        $mireca = new Consultorio;
        $mireca->conexion();
        $array = $mireca->getFotos($fotos);
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) {
                ...
                if ($append_file) {
                    ...
                    $mireca = new Consultorio;
                    $mireca->conexion();
                    $mireca->insertFotos($file->name,$idpaciente,$idtipo);
                }
            } else {
    ...
    public function delete($print_response = true) {
        ...
        foreach ($file_names as $file_name) {
            ...
            session_start();
            $idtipo = $_SESSION['idtipo'];
            $mireca->deleteFotos($file_name,$idtipo);
