...
<div class="container">
    ...
    $id=$_GET['id'];
    $idtipo=$_GET['idtipo'];
    $sql = "SELECT nombre from paciente where idpaciente = $id";
    $dato = $mireca->sqlArray($sql);
    $nombre = $dato[0]['nombre'];
    session_start();
    $_SESSION['idpaciente'] = $id;
    $_SESSION['idtipo'] = $idtipo;
     ?>
     <h2>Agregar Radiografias al paciente:<?php echo "<br>".$nombre; ?> de tipo: <?php echo $idtipo; ?> </h2>
