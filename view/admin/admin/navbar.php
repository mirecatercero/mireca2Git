...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <h1>Añadir Reloj</h1>
      <hr>
      <form class="" action="reloj/nuevo.php" method="post" enctype="multipart/form-data">
        <label for="">Nombre del reloj: </label>
        ...
        <textarea name="descripcion" rows="3" cols="80"></textarea><br>
